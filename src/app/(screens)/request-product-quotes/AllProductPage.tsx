...
function AllProductPage() {
  ...
  console.log("🚀 ~ AllProductPage ~ products:", products);
  ...
  const slug = StaticPageSlug.RequestProductQuotes;
  ...
  const fetchProducts = async () => {
    ...
    try {
      const data = await getProductsFilter(
        `?search=${
          search || ""
        }&category=${category}&brand=${brand}&industry=${industry}${
          sortUrl ? sortUrl : ""
  ...
  return (
    <>
      <style jsx>{`
        ...
        .hero-banner-modern h1,
        .hero-banner-modern .display-6 {
          color: #1e293b;
          font-weight: 800;
          letter-spacing: 1px;
          font-size: 2.2rem;
              ...
              <div className="col-lg-10">
                <div className="text-center mb-4">
                  ...
                  <p className="lead mb-4">
                    Discover quality machinery and tools for all your industrial
                    needs
                  </p>
                </div>
                ...
                <div className="results-header d-flex justify-content-between align-items-center mb-4 p-3">
                  ...
                  <div className="d-none d-sm-block">
                    <small className="text-muted bg-light px-3 py-2 rounded-pill">
                      AllProductPage {page} of {totalPages}
                    </small>
                  </div>
                </div>
                  ...
                  <>
                    ...
                    >
                      ...
                      >
                        ...
                        operations? Our experts are here to help. We take the
                        time to understand your unique requirements, recommend
                        the most suitable products, and provide ongoing support
                        to ensure maximum efficiency. Get in touch with Jaypee
                        Associates today for tailored recommendations.
                      </p>
                      <Button
                        variant="contained"
                        sx={{
