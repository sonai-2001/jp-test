...
import BrandFormModel from "./FaqFormModel";
import { FaEye, FaTrash } from "react-icons/fa";
import { deleteFAQ, getFAQs } from "@/app/services/Faq/FaqApi";
import loader_img from "../../../../public/assets/img/loader_img.png"
import Image from "next/image";
function FAQFormList() {
  const { reset } = useForm();
  ...
  const onSubmitDelete = async () => {
    try {
      const response = await deleteFAQ(getSectorDelete?.id);
      if (response.ok) {
        setSectorCloseModel();
      }
    } catch (error) {
      ...
      >
        ...
        <Modal.Body className="modal-body">
          <div className="deadline-form">
            ...
            >
              Are you sure to delete "{getSectorDelete?.question}" question?
            </h4>
