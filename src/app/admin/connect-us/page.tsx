...
import { getConnectUsList } from "@/app/services/ConnectUs/ConnectUsApi";

function ConnectUsList() {
  const { reset } = useForm();
  ...
  const getCategoryList = async () => {
    setIsLoading(true);
    try {
      const data = await getConnectUsList();
      setSectorList(
  ...
  const formSectorView = (id: string) => {
    router.push(`/admin/connect-us/${id}`)
  }
